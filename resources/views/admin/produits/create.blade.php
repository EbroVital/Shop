                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="nom" id="title" class="form-control @error('nom') is-invalid @enderror" placeholder="nom" value= "{{ old('nom') }}">
                                        @error('nom')
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="prix" id="price" class="form-control @error('prix') is-invalid @enderror" placeholder="prix" value="{{ old('prix')}}">
                                        @error('prix')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                    ...
                    <div class="card mb-3">
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input type="number" name="stock" id="sku" class="form-control @error('stock') is-invalid @enderror" placeholder="stock" value="{{ old('stock')}}">
                                @error('stock')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
